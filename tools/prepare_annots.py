...
def get_cams():
    ...
    for i in range(len(camera_names)):
        ...
        try:
            cams['D'].append(
                intri.getNode(f'D_{camera_name}').mat().T)
        except:
            cams['D'].append(
...
"""
python tools/prepare_annots.py --data_dir data/my_zju_mocap --humans my_313 my_315 my_377 my_386 my_387 my_390 my_392 my_393 my_394 
python tools/prepare_annots.py --data_dir /data3/lihaochen/datasets/synthetic_human_pp --humans jody --use_existing_cam --use_existing_ims
"""
