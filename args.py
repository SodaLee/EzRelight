...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=2048,
        help=(
            "The x resolution for bg conditioning"
        ),
    )
    parser.add_argument(
        "--bg_resolution_y",
        ...
        default=1024,
        help=(
            "The y resolution for bg conditioning"
        ),
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--learning_rate_controlnext",
        type=float,
        default=1e-4,
        help="Initial learning rate (after the potential warmup period) to use for the controlnext.",
    )
    parser.add_argument(
        "--scale_lr",
        action="store_true",
    ...
    parser.add_argument(
        ...
        help="The column of the dataset containing the controlnet background conditioning image.",
    )
    parser.add_argument(
        "--caption_column",
        type=str,
    ...
    parser.add_argument(
        ...
        nargs="+",
        help=(
            "A set of paths to the controlnet background conditioning image be evaluated every `--validation_steps`"
        ),
    )
    parser.add_argument(
