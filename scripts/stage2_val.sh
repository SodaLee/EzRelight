...
--variant fp16 \
--use_safetensors \
--output_dir "/data2/lihaochen/EzRelight_chps/stage2/try_0203_from_0202" \
--logging_dir "logs" \
--resolution 1024 \
...
--stage1_chp_path "/data2/lihaochen/EzRelight_chps/stage2/try_0203_from_0202/checkpoints/final"