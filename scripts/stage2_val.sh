...
--variant fp16 \
--use_safetensors \
--output_dir "/data2/lihaochen/EzRelight_chps/stage2/try_0225_from_0217" \
--logging_dir "logs" \
--resolution 1024 \
...
--stage1_chp_path "/data2/lihaochen/EzRelight_chps/stage2/try_0225_from_0217/checkpoints/final"